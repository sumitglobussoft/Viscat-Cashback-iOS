...
- (IBAction)buttonTypeButtonClicked:(id)sender {
    ...
    KakaoTalkLinkAction *webLinkActionUsingPC = [KakaoTalkLinkAction createWebAction:@"http://www.kakao.com"];
    
    KakaoTalkLinkObject *buttonObj = [KakaoTalkLinkObject createAppButton:@"Test Button"
                                                                  actions:@[androidAppAction, iphoneAppAction, ipadAppAction, webLinkActionUsingPC]];
