...
@implementation KakaoTalkSampleAppDelegate

- (void)showLoginView {
    KakaoTalkSampleLoginViewController *loginViewController = [[KakaoTalkSampleLoginViewController alloc] initWithNibName:nil
                                                                                                                   bundle:nil];
...
- (void)showMainView {
    KakaoTalkSampleViewController *mainViewController = [[KakaoTalkSampleViewController alloc] init];
